...
switch (mode)
{
    ...
    case "gridtrain":        await GridCommands.RunGridTrain(client);                            break;
    ...
    default:
        ...
        Console.WriteLine("  dotnet run -- coevolvetrain      Coevolve DipLong+SwingLong+Router+Guard (4 cycles, parallel)");
